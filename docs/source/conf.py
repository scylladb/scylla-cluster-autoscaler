...
project = 'Scylla Cluster Autoscaler'
...
html_theme_options = {
    ...
    ('Scylla Cluster Autoscaler', 'https://scylladb.github.io/scylla-cluster-autoscaler/')], #TODO is this the final domain
    'github_issues_repository': 'scylladb/scylla-cluster-autoscaler',
...
htmlhelp_basename = 'ScyllaClusterAutoscalerDocumentationdoc'

# URL which points to the root of the HTML documentation.
html_baseurl = 'https://scylladb.github.io/scylla-cluster-autoscaler'
...
smv_branch_whitelist = multiversion_regex_builder('master')
