...
This is a guide to deploy a Scylla Cluster Autoscaler in a Kubernetes environment.
Please refer to the various [deployment instructions](https://operator.docs.scylladb.com/stable/) to get Scylla Operator running and set up [monitoring](https://operator.docs.scylladb.com/stable/monitoring.html) beforehand.
